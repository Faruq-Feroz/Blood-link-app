        ...
        <div className="container" id='appointment'>
            <div className="form-section">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="number" name="bodyWeight" placeholder="Body Weight (kg)" value={formData.bodyWeight} onChange={handleChange} required />
                    <input type="text" name="disease" placeholder="Any Disease (optional)" value={formData.disease} onChange={handleChange} />
